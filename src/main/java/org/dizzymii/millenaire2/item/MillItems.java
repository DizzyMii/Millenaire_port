...
public class MillItems {
    ...
    // ========== Amulets ==========
    public static final DeferredItem<Item> AMULET_VISHNU = registerItem("vishnu_amulet", () -> new ItemAmuletVishnu(props1()));
    public static final DeferredItem<Item> AMULET_ALCHEMIST = registerItem("alchemist_amulet", () -> new ItemAmuletAlchemist(props1()));
    public static final DeferredItem<Item> AMULET_YGGDRASIL = registerItem("yggdrasil_amulet", () -> new ItemAmuletYggdrasil(props1()));
    public static final DeferredItem<Item> AMULET_SKOLL_HATI = registerItem("skoll_hati_amulet", () -> new ItemAmuletSkollHati(props1()));
    ...
    // ========== Armor — Mayan Crown ==========
    public static final DeferredItem<Item> MAYAN_QUEST_CROWN = registerItem("mayanquestcrown", () -> new ItemMayanQuestCrown(props1()));

    // ========== Parchments ==========
    public static final DeferredItem<Item> PARCHMENT_NORMAN_VILLAGERS = registerItem("parchment_normanvillagers", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_NORMAN_BUILDINGS = registerItem("parchment_normanbuildings", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_NORMAN_ITEMS = registerItem("parchment_normanitems", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_NORMAN_COMPLETE = registerItem("parchment_normanfull", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_INDIAN_VILLAGERS = registerItem("parchment_indianvillagers", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_INDIAN_BUILDINGS = registerItem("parchment_indianbuildings", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_INDIAN_ITEMS = registerItem("parchment_indianitems", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_INDIAN_COMPLETE = registerItem("parchment_indianfull", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_MAYAN_VILLAGERS = registerItem("parchment_mayanvillagers", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_MAYAN_BUILDINGS = registerItem("parchment_mayanbuildings", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_MAYAN_ITEMS = registerItem("parchment_mayanitems", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_MAYAN_COMPLETE = registerItem("parchment_mayanfull", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_JAPANESE_VILLAGERS = registerItem("parchment_japanesevillagers", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_JAPANESE_BUILDINGS = registerItem("parchment_japanesebuildings", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_JAPANESE_ITEMS = registerItem("parchment_japaneseitems", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_JAPANESE_COMPLETE = registerItem("parchment_japanesefull", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_VILLAGE_SCROLL = registerItem("parchment_villagescroll", () -> new ItemParchment(props1()));
    public static final DeferredItem<Item> PARCHMENT_SADHU = registerItem("parchment_sadhu", () -> new ItemParchment(props1()));
