...
public final class ClientPacketHandler {
    ...
    // Client-side quest instance
    @javax.annotation.Nullable public static String cachedQuestId = null;
    public static int cachedQuestStep = 0;
